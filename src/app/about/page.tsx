  ...
  return (
    <div className="pt-28 sm:pt-32 pb-20 sm:pb-24 min-h-screen bg-[#EBF1FA]/70 dark:bg-[#0B1320]/60 backdrop-blur-[2px] text-[#152238] dark:text-white transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Page Hero */}
        <ScrollReveal variant="fade-up" className="text-center max-w-3xl mx-auto space-y-3 mb-12 sm:mb-16">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#8EA9D3]/20 text-[#152238] dark:text-brand-steel-light text-xs font-semibold uppercase tracking-wider backdrop-blur-md">
            {about.badge}
          </div>
        ...
        <ScrollReveal variant="zoom-in" duration={0.7} className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center mb-16 sm:mb-20 bg-white/85 dark:bg-[#111C2E]/80 backdrop-blur-md rounded-3xl p-6 sm:p-10 lg:p-12 shadow-sm border border-[#8EA9D3]/30 dark:border-slate-800">
        ...
        <div className="mb-16 sm:mb-20">
          <ScrollReveal variant="fade-up" className="text-center max-w-2xl mx-auto space-y-2 mb-10 sm:mb-12">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-rust/15 text-brand-rust dark:text-brand-rust-light text-xs font-semibold uppercase backdrop-blur-md">
          ...
          <ScrollReveal variant="fade-up" delay={0.15} className="bg-white/85 dark:bg-[#111C2E]/80 backdrop-blur-md rounded-3xl p-6 sm:p-10 lg:p-12 border border-[#8EA9D3]/30 dark:border-slate-800 shadow-sm max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
            ...
            <div className="md:col-span-8 space-y-4">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {currentSkills.map((skill, sIdx) => (
                    <span
                      key={sIdx}
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-[#F2F7FD]/90 dark:bg-[#0B1320]/80 border border-[#8EA9D3]/30 dark:border-slate-700/80 text-xs font-semibold text-[#152238] dark:text-slate-200 hover:border-brand-steel transition-colors"
                    >
              ...
              <div className="pt-2">
                <Link
                  href="/contact"
                  className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl bg-brand-rust hover:bg-brand-rust-light text-white text-xs font-bold transition-all shadow-sm hover:shadow-lg hover:shadow-brand-rust/20"
                >
        ...
        <StaggerContainer delayChildren={0.2} staggerChildren={0.15} className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mb-16 sm:mb-20">
          <StaggerItem className="bg-white/85 dark:bg-[#0E1728]/80 backdrop-blur-md text-[#152238] dark:text-white rounded-3xl p-6 sm:p-8 shadow-sm border border-[#8EA9D3]/30 dark:border-brand-steel/20 space-y-3 hover:-translate-y-1 transition-transform duration-300">
          ...
          <StaggerItem className="bg-white/85 dark:bg-[#111C2E]/80 backdrop-blur-md text-[#152238] dark:text-white rounded-3xl p-6 sm:p-8 shadow-sm border border-[#8EA9D3]/30 dark:border-slate-800 space-y-3 hover:-translate-y-1 transition-transform duration-300">
        ...
        {/* Office Location */}
        <ScrollReveal variant="fade-up" className="bg-white/85 dark:bg-[#0E1728]/80 backdrop-blur-md rounded-3xl p-6 sm:p-10 border border-[#8EA9D3]/30 dark:border-slate-800 shadow-sm">
          ...
          <div className="max-w-md mx-auto">
            {officeLocations.map((loc) => (
              <div key={loc.city} className="bg-[#F2F7FD]/90 dark:bg-[#111C2E]/90 p-5 rounded-2xl shadow-sm border border-[#8EA9D3]/30 dark:border-slate-800 space-y-2 text-center">
