...
export default function AboutPage() {
  return (
    <div className="pt-28 sm:pt-32 pb-20 sm:pb-24 min-h-screen bg-[#F8FAFC] dark:bg-[#0B1320] text-slate-900 dark:text-white transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center mb-16 sm:mb-20 bg-white dark:bg-[#111C2E] rounded-3xl p-6 sm:p-10 lg:p-12 shadow-sm border border-slate-200 dark:border-slate-800">
        ...
        <div className="mb-16 sm:mb-20">
          <div className="text-center max-w-2xl mx-auto space-y-2 mb-10 sm:mb-12">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-rust/10 text-brand-rust dark:text-brand-rust-light text-xs font-semibold uppercase">
          ...
          <div className="bg-white dark:bg-[#111C2E] rounded-3xl p-6 sm:p-10 lg:p-12 border border-slate-200 dark:border-slate-800 shadow-sm max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
            
            {/* Portrait Photo (4 cols) */}
            <div className="md:col-span-4 flex flex-col items-center text-center">
              <div className="relative w-48 h-48 sm:w-56 sm:h-56 rounded-2xl overflow-hidden shadow-md border-2 border-slate-200 dark:border-slate-700 bg-slate-100 dark:bg-slate-800">
                <Image
            ...
            <div className="md:col-span-8 space-y-4">
              <div>
                <h4 className="text-xs uppercase font-bold tracking-wider text-brand-navy dark:text-brand-steel-light mb-1.5">
              ...
              {/* Skills Tags Grid */}
              <div>
                <h5 className="text-[11px] uppercase font-bold tracking-wider text-slate-500 dark:text-slate-400 mb-2.5">
                ...
                <div className="flex flex-wrap gap-2">
                  {principalConsultant.skills.map((skill, sIdx) => (
                    <span
                      key={sIdx}
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-50 dark:bg-[#0B1320] border border-slate-200 dark:border-slate-700/80 text-xs font-medium text-slate-800 dark:text-slate-200"
                    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mb-16 sm:mb-20">
          <div className="bg-white dark:bg-[#0E1728] text-slate-900 dark:text-white rounded-3xl p-6 sm:p-8 shadow-sm border border-slate-200 dark:border-brand-steel/20 space-y-3">
            <div className="w-10 h-10 rounded-xl bg-brand-steel/20 text-brand-navy dark:text-brand-steel-light flex items-center justify-center">
          ...
          <div className="bg-white dark:bg-[#111C2E] text-slate-900 dark:text-white rounded-3xl p-6 sm:p-8 shadow-sm border border-slate-200 dark:border-slate-800 space-y-3">
            <div className="w-10 h-10 rounded-xl bg-brand-rust/10 text-brand-rust dark:text-brand-rust-light flex items-center justify-center">
        ...
        {/* Office Location */}
        <div className="bg-white dark:bg-[#0E1728] rounded-3xl p-6 sm:p-10 border border-slate-200 dark:border-slate-800 shadow-sm">
          <div className="text-center max-w-xl mx-auto mb-6 space-y-1">
            <h3 className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-white">Head Office</h3>
            <p className="text-xs text-slate-600 dark:text-slate-400 font-normal">Supporting clients with strategic advisory and operational excellence.</p>
          </div>

          <div className="max-w-md mx-auto">
            {officeLocations.map((loc) => (
              <div key={loc.city} className="bg-slate-50 dark:bg-[#111C2E] p-5 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 space-y-2 text-center">
                ...
                <p className="text-xs text-slate-600 dark:text-slate-400 font-normal">{loc.address}</p>
                <div className="text-xs font-semibold text-brand-navy dark:text-brand-steel-light pt-1">
                  Direct: {loc.phone}
                </div>
              </div>
            ))}
