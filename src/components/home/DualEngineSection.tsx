...
export default function DualEngineSection() {
  ...
  return (
    <section className="py-16 sm:py-24 bg-white/80 dark:bg-[#0E1626]/75 backdrop-blur-[2px] text-[#152238] dark:text-white transition-colors duration-300 overflow-hidden">
